package com.example.cpu11341_local.bannerviewtest.BannerView;
...
import com.example.cpu11341_local.bannerviewtest.R;
...
//                if (!isInfinite && position== viewPagerAdapter.getCount() - 2){
